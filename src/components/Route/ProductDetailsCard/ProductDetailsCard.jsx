    ...
    <div className="bg-[#fff]">
      {data ? (
        <div className="fixed w-full h-screen top-0 left-0  bg-[#00000030] z-40 flex items-center justify-center">
          <div className="w-[90%]. 800px:w-[60%] h-[90vh] overflow-y-scroll 800px:h-[75vh] bg-white rounded-md relative p-4">
            <RxCross1
              size={30}
            ...
            <div className="block w-full 800px:flex">
              <div className="w-full 700px:w-[50%]">
                <div className="h-[50%]">
                  <img
              ...
              <div className="w-full 700px:w-[50%] pt-5 pl-[5px] pr-[5px]">
                ...
                <div className="flex pt-3">
                  <h4 className={`${styles.productDiscountPrice}`}>
                    {formatNumber.format(data.discountPrice)}₫
                  </h4>
                  <h3 className={`${styles.price}`}>
                    {data.originalPrice
                      ? formatNumber.format(data.originalPrice) + "₫"
                      : null}
                  </h3>
                </div>

        ...
        <div className="bt-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form action="" className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="appearance-none block w-full p-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:ouline-blue-500 focus:ouline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                ></input>
                {visible ? (
                  <AiOutlineEye
            ...
            <div>
              <button
                type="submit"
                className="grou[ relative w-full h-{40px} flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700"
              >
                Đăng nhập
              </button>
            </div>

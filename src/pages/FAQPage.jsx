      ...
      <div className="mx-auto space-y-4">
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          >
            <span className="text-lg font-medium text-gray-900">
              Chính sách hoàn trả của cửa hàng là gì?
            </span>
            {activeTab === 2 ? (
              <svg
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                Để bắt đầu trả lại, vui lòng gửi email cho chúng tôi theo địa
                chỉ eshop247@gmail.com với số đơn đặt hàng của bạn và giải thích
                ngắn gọn về lý do bạn trả lại mặt hàng.
              </p>
            </div>
          )}
        </div>
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                cách gửi email cho chúng tôi tại eshop247@gmail.com hoặc gọi cho
                chúng tôi theo số 0387113343 trong khoảng thời gian từ 9 giờ
                sáng đến 5 giờ chiều EST, từ Thứ Hai đến Thứ Sáu.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Chúng tôi chấp nhận visa, mastercard, phương thức thanh toán
